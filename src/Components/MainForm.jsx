...
const MainForm = ({ mainActive, inner, pickupData, dropData, mainDate, mainTime, returnMainDate }) => {
    ...
    return (
        <HomeLayout>
        <div className=" min-w-[19.5rem] w-full mb-8 max-w-[29rem] p-4 h-fit mx-auto my-auto ">

            <div className="grid rounded-md overflow-hidden backdrop-blur-sm bg-[#00000033] text-[0.9rem] grid-cols-3 font-semibold">
                <button
                    onClick={() => setActive(1)}
                    className={`py-[0.3rem] px-2 border-[0.3px] border-gray-400 rounded-l-md border-r-none transition-all duration-300 ease-in-out transform ${active === 1 ? 'bg-green-300 text-black shadow-lg' : 'bg-transparent text-black hover:bg-[#f0f4f8] hover:text-main scale-100'
                        }`}
                >
                    Outstation
                </button>
                ...
                <button
                    onClick={() => setActive(2)}
                    className={`py-[0.3rem] px-2 border-[0.3px] border-gray-400 transition-all duration-300 ease-in-out transform ${active === 2 ? 'bg-green-300 text-black shadow-lg' : 'bg-transparent text-black hover:bg-[#f0f4f8] scale-100 hover:text-main'
                        }`}
                >
                    Local Trip
                </button>
                ...
                <button
                    onClick={() => setActive(3)}
                    className={`py-[0.3rem] px-2 border-[0.3px] rounded-r-md border-gray-400 transition-all duration-300 ease-in-out transform ${active === 3 ? 'bg-green-300 text-black shadow-lg' : 'bg-transparent text-black hover:bg-[#f0f4f8] scale-100 hover:text-main'
                        }`}
                >
                    Airport Trip
                </button>
            ...
            <form onSubmit={handleLocalTripSubmit} className="relative flex flex-col gap-4 p-5 px-3 mt-2 bg-gray-300 rounded-lg ">
...
${outstationActive === 1.1 ? 'bg-green-300 text-black' : 'bg-gray-300 text-light hover:bg-[#f0f4f8]'}`}
                            >
                                One way
                            </div>
                            <div
...
${outstationActive === 1.2 ? 'bg-green-300 text-black' : 'bg-gray-300 text-light hover:bg-[#f0f4f8]'}`}
                            >
                                Round Trip
                            </div>
                        </div>
                        ...
                        {outstationActive === 1.1 &&
                            <div
                                ...
                                <div
                                    ...
                                    {showOnewayPickup && (
                                        <ul className="absolute z-10 w-[88%] overflow-y-auto bg-gray-300 border border-gray-200 rounded-md shadow-md max-h-60">
                                ...
                                <div className='relative w-full border-t border-gray-300'>
                                    <div className='absolute top-[-14px] border-main w-fit bg-gray-300 right-4 border p-[0.35rem] text-[0.95rem] rounded-full'>
                                ...
                                <div
                                    ...
                                    {showOnewayDrop && (
                                        <ul className="absolute z-10 w-full overflow-y-auto bg-gray-300 border border-gray-200 rounded-md shadow-md max-h-60">
                        ...
                        {outstationActive === 1.2 &&
                            <div
                                ...
                                <div
                                    ...
                                    className='relative w-full'>
                                    <label className='w-full text-light text-black py-1 text-[0.8rem] sm:text-[0.85rem] md:text-[0.9rem]'>Pick-up Location</label>
                                    <input
                                ...
                                {/* Arrow Icon */}
                                <div className='relative w-full border-t border-gray-300'>
                                    <div className='absolute top-[-15px] border-main w-fit bg-gray-300 right-4 border p-[0.35rem] text-[0.95rem] rounded-full'>
                                        <GoArrowSwitch className=" top-10 rotate-[90deg]   text-main" />
                                    </div>
                                </div>
                                <div
                    ...
                    <>
                        <div className='w-full flex cursor-pointer  items-center justify-center text-[0.8rem] sm:text-[0.85rem] md:text-[0.9rem] tracking-wide'>
                            <div
                                ...
                                className={`py-[0.15rem] font-semibold px-4 border-[0.3px] rounded-l-full border-gray-400 transform scale-105 transition-all duration-500 ease-in-out
${airportActive === 3.1 ? 'bg-green-300 text-black' : 'bg-gray-300 text-main hover:bg-[#f0f4f8]'}`}
                            >
                                Drop
                            </div>
                            <div
                                ...
                                className={`py-[0.15rem] font-semibold px-4 border-[0.3px] rounded-r-full border-gray-400 transform scale-105 transition-all duration-500 ease-in-out
${airportActive === 3.2 ? 'bg-green-300 text-black' : 'bg-gray-300 text-main hover:bg-[#f0f4f8]'}`}
                            >
                                Pickup
                            </div>
                        </div>
                ...
                {active === 2 &&
                    <div className="relative border p-1 rounded-md pr-2 border-main bg-[#F7FBFF] pl-7 flex flex-col items-center">
                        ...
                        {focus && searchInput && filteredCities.length > 0 && (
                            <div
                                ref={dropdownRef}
                                className="absolute left-0 z-10 w-full bg-gray-300 border border-gray-300 rounded-md shadow-lg top-full"
                            >
                ...
                <button
                    type="submit"
                    className="py-2 px-4 bg-green-300 text-black font-semibold tracking-wide rounded-md hover:bg-[#1780a4] transition duration-300 ease-in-out shadow-lg"
                >
                    Explore Cab
                </button>
            </form>
