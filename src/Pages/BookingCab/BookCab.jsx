        ...
        <div className='flex flex-wrap items-start justify-center min-h-[90vh] p-4 py-8 bg-gray-100'>
            <div className='flex flex-col items-center justify-center gap-2'>
                <div className='flex flex-wrap items-start justify-center gap-4'>
                    <div
                        className='bg-white  flex flex-col   min-w-[19.5rem] text-black max-w-[29rem] w-[90vw] hover:from-[#f3fbff] cursor-pointer transition-all duration-500 border border-black hover:bg-gradient-to-b hover:to-[#f8fafc] rounded shadow-[0px_5px_10px_-6px_#808080] overflow-hidden'
                    >
                        ...
                        <div>
                            <div className='flex items-center justify-between rounded rounded-b-none bg-gradient-to-tr from-blue-200 via-blue-100 to-[#e6f7ff]'>
                                <button
                                    ...
                                    className={`flex items-center gap-1 w-full p-2 text-[0.8rem]  justify-center  font-semibold ${detailsActive === 1 ? 'bg-green-400 text-white' : 'bg-transparent'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1 p-2 text-[0.8rem] w-full justify-center font-semibold ${detailsActive === 2 ? 'bg-green-400 text-white' : 'bg-transparent'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1 p-2 text-[0.8rem] justify-center w-full font-semibold ${detailsActive === 3 ? 'bg-green-400 text-white' : 'bg-transparent'}`}
                                >
                    ...
                    <form onSubmit={handleSubmit} noValidate className='bg-white   flex flex-col  border border-black  min-w-[19.5rem] text-black max-w-[29rem] w-[90vw]  cursor-pointer transition-all duration-500 hover:bg-gradient-to-b  rounded shadow-[0px_5px_10px_-6px_#808080] overflow-hidden'>
                        {currentStep === 1 &&
                            <>
                                <div className='flex items-center gap-2 p-2 rounded rounded-b-none bg-gradient-to-tr from-blue-200 via-blue-100 to-[#e6f7ff]'>
                                ...
                                <div className='p-2'>
                                    <div className="relative flex flex-col items-center w-full p-1 px-0 mb-1 border-b border-black">
                                        ...
                                        <div className="flex items-center gap-2 mt-1 tracking-wide border border-gray-300 rounded bg-transparent outline-none placeholder:text-[#808080] text-[0.95rem]">
                                            ...
                                            {discountPrice > 0 ?
                                                ...
                                                <div
                                                    ...
                                                    className="px-5 py-[0.4rem] bg-green-600  text-black font-semibold rounded-r hover:bg-blue-600 transition-colors text-[0.85rem]"
                                                >
