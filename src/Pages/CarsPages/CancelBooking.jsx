...
const CancelBooking = () => {
    ...
    const getTimeFilteredData = () => {
        ...
        // Filter by status (where status is true and isComplete is false)
        filteredData = filteredData.filter(order =>  order.isComplete === false);
    
        // New: Filter by isCancel being true and isCancel is a boolean
        filteredData = filteredData.filter(order => order.isCancel === true && typeof order.isCancel === 'boolean');
